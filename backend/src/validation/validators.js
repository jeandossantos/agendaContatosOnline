...
function isEmailOrError(value, msg, ClassError) {
  const emailRegex = /^[^\s@]+@[^\s@]+\.[^\s@]+$/;
  if (!emailRegex.test(value)) throw new ClassError(msg);
}

export { existsOrError, notExistsOrError, equalsOrError, isEmailOrError };
